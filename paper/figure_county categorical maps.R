...
fig2a = plot_map_estimates_categorical(df,level="county",plot_var = "cosmos_ow",fips_var = "fips",plot_var_label="",
                                       breaks=c(0,15,30,35,40,45,50,55,85)) + 
  figure2_theme
fig2b = plot_map_estimates_categorical(df,level="county",plot_var = "pursuant_ow",fips_var = "fips",plot_var_label="",
                                       breaks=c(0,15,30,35,40,45,50,55,85))+ 
  figure2_theme
fig2c = plot_map_estimates_categorical(df,level="county",plot_var = "cosmos_ob",fips_var = "fips",plot_var_label="",
                                       breaks=c(0,15,30,35,40,45,50,55,85))+ 
  figure2_theme
fig2d = plot_map_estimates_categorical(df,level="county",plot_var = "pursuant_ob",fips_var = "fips",plot_var_label="",
                                       breaks=c(0,15,30,35,40,45,50,55,85))+ 
  figure2_theme
...
ggarrange(fig2a,fig2b,fig2c,fig2d,
          ...
          common.legend = TRUE,
          legend="bottom") %>% 
  ggsave(.,filename=paste0(path_kiosk_user_patterns_folder,"/figures/qc/figure_2_county categorical prevalence of overweight and obesity.jpg"),
         width = 10,height = 8)
...
fig3a = plot_map_estimates_categorical(df,level="county",plot_var = "places_ob",fips_var = "fips",plot_var_label="",
                                       breaks=c(0,15,30,35,40,45,50,55,85)) + 
  figure3_theme
...
ggarrange(fig3a,
  ...
  ggsave(.,filename=paste0(path_kiosk_user_patterns_folder,"/figures/qc/figure_3_correlation of obesity with categorical map between data sources.jpg"),
         width = 8,height = 8)
