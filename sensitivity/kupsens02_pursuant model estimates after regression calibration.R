...
pursuant_files = list.files(paste0(path_kiosk_user_patterns_folder,"/working/model/ktana10"),full.names = TRUE) %>% 
...
write_csv(stratified_df,"sensitivity/kupsens02_pursuant model estimates after regression calibration.csv")
